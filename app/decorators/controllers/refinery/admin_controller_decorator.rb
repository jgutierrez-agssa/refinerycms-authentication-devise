...
# Precargar la clase original primero
require_dependency "refinery/admin_controller"

# Aplicar el decorador
Refinery::AdminController.prepend Controllers::Refinery::AdminControllerDecorator
